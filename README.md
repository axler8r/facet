...
hyphens. Equality retains string comparison semantics; ordering uses numeric
conversion. Missing attributes do not satisfy comparisons, including `!=`.
Malformed expressions are rejected; parentheses and other query features are not
supported.
